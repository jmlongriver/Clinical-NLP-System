 ...
 * @generated */
public class BrandName_Type extends Annotation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (BrandName_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = BrandName_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new BrandName(addr, BrandName_Type.this);
  			   BrandName_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new BrandName(addr, BrandName_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = BrandName.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.UIMA.medex.BrandName");
  ...
  public String getSemantic_type(int addr) {
      ...
      jcas.throwFeatMissing("semantic_type", "org.apache.UIMA.medex.BrandName");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public BrandName_Type(JCas jcas, Type casType) {
    super(jcas, casType);
