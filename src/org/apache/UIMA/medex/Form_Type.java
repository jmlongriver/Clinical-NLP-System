 ...
 * @generated */
public class Form_Type extends Annotation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Form_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Form_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Form(addr, Form_Type.this);
  			   Form_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Form(addr, Form_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = Form.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.UIMA.medex.Form");
  ...
  public String getSemantic_type(int addr) {
      ...
      jcas.throwFeatMissing("semantic_type", "org.apache.UIMA.medex.Form");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public Form_Type(JCas jcas, Type casType) {
    super(jcas, casType);
