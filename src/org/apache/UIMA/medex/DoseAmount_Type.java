 ...
 * @generated */
public class DoseAmount_Type extends Annotation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (DoseAmount_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = DoseAmount_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new DoseAmount(addr, DoseAmount_Type.this);
  			   DoseAmount_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new DoseAmount(addr, DoseAmount_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = DoseAmount.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.UIMA.medex.DoseAmount");
  ...
  public String getSemantic_type(int addr) {
      ...
      jcas.throwFeatMissing("semantic_type", "org.apache.UIMA.medex.DoseAmount");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public DoseAmount_Type(JCas jcas, Type casType) {
    super(jcas, casType);
