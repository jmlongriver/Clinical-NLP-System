 ...
 * @generated */
public class Route_Type extends Annotation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Route_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Route_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Route(addr, Route_Type.this);
  			   Route_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Route(addr, Route_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = Route.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.UIMA.medex.Route");
  ...
  public String getSemantic_type(int addr) {
      ...
      jcas.throwFeatMissing("semantic_type", "org.apache.UIMA.medex.Route");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public Route_Type(JCas jcas, Type casType) {
    super(jcas, casType);
