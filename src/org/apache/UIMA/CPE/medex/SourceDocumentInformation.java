...
/* First created by JCasGen Thu Nov 15 22:58:41 CST 2012 */
 ...
 * Updated by JCasGen Thu Nov 15 22:59:05 CST 2012
 * XML source: /Users/ywu4/coding/eclipse/MedEx_UIMA/desc/UIMAMedexConsumerDescriptor.xml
 * @generated */
public class SourceDocumentInformation extends Annotation {
  ...
  public String getUri() {
    if (SourceDocumentInformation_Type.featOkTst && ((SourceDocumentInformation_Type)jcasType).casFeat_uri == null)
      jcasType.jcas.throwFeatMissing("uri", "org.apache.UIMA.CPE.medex.SourceDocumentInformation");
  ...
  public int getOffsetInSource() {
    if (SourceDocumentInformation_Type.featOkTst && ((SourceDocumentInformation_Type)jcasType).casFeat_offsetInSource == null)
      jcasType.jcas.throwFeatMissing("offsetInSource", "org.apache.UIMA.CPE.medex.SourceDocumentInformation");
  ...
  public int getDocumentSize() {
    if (SourceDocumentInformation_Type.featOkTst && ((SourceDocumentInformation_Type)jcasType).casFeat_documentSize == null)
      jcasType.jcas.throwFeatMissing("documentSize", "org.apache.UIMA.CPE.medex.SourceDocumentInformation");
  ...
  public boolean getLastSegment() {
    if (SourceDocumentInformation_Type.featOkTst && ((SourceDocumentInformation_Type)jcasType).casFeat_lastSegment == null)
      jcasType.jcas.throwFeatMissing("lastSegment", "org.apache.UIMA.CPE.medex.SourceDocumentInformation");
